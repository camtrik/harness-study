...
- If it is `--wrap-up`: strip the flag, execute the spike-wrap-up workflow from @/Users/ebbi/Work/harness-study/gsd/.claude/get-shit-done/workflows/spike-wrap-up.md.
- Otherwise: pass all of $ARGUMENTS as the idea to the spike workflow from @/Users/ebbi/Work/harness-study/gsd/.claude/get-shit-done/workflows/spike.md end-to-end.
