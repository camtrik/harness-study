...
```
Task(
  prompt="Read /Users/ebbi/Work/harness-study/gsd/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ebbi/Work/harness-study/gsd/.claude/get-shit-done/templates/SECURITY.md`
