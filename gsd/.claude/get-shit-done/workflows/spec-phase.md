...
```bash
INIT=$(node "/Users/ebbi/Work/harness-study/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/ebbi/Work/harness-study/gsd/.claude/get-shit-done/templates/spec.md.
