...
```bash
INIT=$(node "/Users/ebbi/Work/harness-study/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/ebbi/Work/harness-study/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
