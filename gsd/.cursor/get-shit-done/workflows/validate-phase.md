...
```
Task(
  prompt="Read /Users/ebbi/Work/harness-study/gsd/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ebbi/Work/harness-study/gsd/.cursor/get-shit-done/templates/VALIDATION.md`
